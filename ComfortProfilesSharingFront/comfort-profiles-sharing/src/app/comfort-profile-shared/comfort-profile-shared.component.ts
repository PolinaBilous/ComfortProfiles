...
@Component({
  selector: 'app-comfort-profile-shared',
  templateUrl: './comfort-profile-shared.component.html',
  styleUrls: ['./comfort-profile-shared.component.css']
})
export class ComfortProfileSharedComponent implements OnInit {
